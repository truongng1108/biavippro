...
"[project]/Desktop/khách/components/add-to-cart-button.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AddToCartButton({ item, inStock = true, variant = "default", size = "lg", className = "" }) {
    _s();
    const { addItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$kh$e1$ch$2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(AddToCartButton, "kvuvm0bTdcCqrI710+tV5Z9PwTQ=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_kh%C3%A1ch_components_add-to-cart-button_tsx_33fd7bfa._.js.map